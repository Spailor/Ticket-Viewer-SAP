...
<asp:Content ID="ContentHolder" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    ...
    <script type="text/javascript">
        function OnGridFocusedRowChanged() {
            ...
            ProductsGridView.GetRowValues(ProductsGridView.GetFocusedRowIndex(), 'ID;IstekTarihiSaati;OnemDerecesiAdi;IstekSahibiAdiSoyadi;IstekSirketAdi;IstekAciklama;IstekSirketKodu;IstekSahibiMailAdresi;ExternalTicketNumber;AlternativeTicketNumber;Moduller;DosyaEkleri', OnGetRowValues);
        }
                            ...
                            <table style="width:300px;" >
                                <tr>
                                    <td style="text-align:center; padding:20px 0 20px 0;" >
                                        Seçmiş olduğunuz çağrı isteğini onaylamak istediğinizden eminmisiniz?
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            <table style="width:300px;" >
                                <tr>
                                    <td style="text-align:center; padding:20px 0 20px 0;" >
                                        Seçmiş olduğunuz çağrı isteğini reddetmek istediğinizden eminmisiniz?
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:center" >
    ...
    <h1>Bekleyen Çağrı İstekleri</h1>
    <dx:ASPxGridView ID="ProductsGridView" runat="server" CssClass="gridView"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="OnemDerecesiAdi" Caption="Önem Derecesi" Width="10%" VisibleIndex="2" />
            ...
            <dx:GridViewDataTextColumn FieldName="IstekAciklama" Caption="Açıklama" Width="35%" VisibleIndex="5" />
