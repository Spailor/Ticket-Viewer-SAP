<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductsOnayBekleyenIsteklerim.aspx.cs" MasterPageFile="~/SiteBase.master" Inherits="Products" %>
...
<%--    <dx:ASPxCallback ID="callbackEvrak"
    ...
    <h1>Onay Bekleyen İsteklerim</h1>
    <dx:ASPxGridView ID="ProductsGridView" runat="server" CssClass="gridView"
        ...
        <%--    <dx:GridViewCommandColumn VisibleIndex="0" Width="70px" MinWidth="60" ButtonType="Image" Caption=" ">
            ...
            <dx:GridViewDataTextColumn FieldName="ID" Caption="Ticket ID" Width="10%" CellStyle-HorizontalAlign="Left" VisibleIndex="0" />
