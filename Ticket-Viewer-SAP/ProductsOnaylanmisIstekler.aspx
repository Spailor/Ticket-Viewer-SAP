<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductsOnaylanmisIstekler.aspx.cs" MasterPageFile="~/SiteBase.master" Inherits="Products" %>
...
<%--    <dx:ASPxCallback ID="callbackEvrak"
    ...
    <dx:ASPxGridView ID="ProductsGridView" runat="server" CssClass="gridView"
        ...
        <%--    <dx:GridViewCommandColumn VisibleIndex="0" Width="70px" MinWidth="60" ButtonType="Image" Caption=" ">
            ...
            <dx:GridViewDataTextColumn FieldName="SonucAciklama" Caption="Çözüm Açıklaması" Width="35%" VisibleIndex="12" Visible="false" />

            <dx:GridViewDataTextColumn FieldName="CagriDurumu" Caption="Cagri Durumu" Width="10%" VisibleIndex="13" />
            <dx:GridViewDataTextColumn FieldName="DanismanAdiSoyadi" Caption="Danışman Adı" Width="15%" VisibleIndex="14" />
  ...
  <%--  <dx:ASPxCallback ID="callbackEkDosyalar"
    ...
    <div class="productDetailsHolder">
        ...
        <div class="productDetailsChartsHolder2">
            ...
            <h5>Dosya Ekleri</h5>
            <p class="description2" style="margin-bottom: 0px;">
                <dx:ASPxLabel ID="ASPxLabel1" ClientInstanceName="ASPxLabel1" 
                    runat="server" CssClass="descriptionLabel2">
                </dx:ASPxLabel>
