<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductsOnaylanmisIsteklerim.aspx.cs" MasterPageFile="~/SiteBase.master" Inherits="Products" %>
...
<%--    <dx:ASPxCallback ID="callbackEvrak"
    ...
    <dx:ASPxGridView ID="ProductsGridView" runat="server" CssClass="gridView"
        ...
        <%--    <dx:GridViewCommandColumn VisibleIndex="0" Width="70px" MinWidth="60" ButtonType="Image" Caption=" ">
            ...
            <dx:GridViewDataTextColumn FieldName="IstekSahibiAdiSoyadi" Caption="Adı Soyadı" Width="15%" VisibleIndex="3" Visible="false" />
            <dx:GridViewDataTextColumn FieldName="IstekSirketAdi" Caption="Şirket Adı" Width="20%" VisibleIndex="4" />
            <dx:GridViewDataTextColumn FieldName="IstekAciklama" Caption="Açıklama" Width="25%" VisibleIndex="5" />
            ...
            <dx:GridViewDataTextColumn FieldName="SonucAciklama" Caption="Çözüm Açıklaması" Width="25%" VisibleIndex="12" />
            <dx:GridViewDataTextColumn FieldName="DanismanAdiSoyadi" Caption="Danışman Adı" Width="15%" VisibleIndex="13" />
