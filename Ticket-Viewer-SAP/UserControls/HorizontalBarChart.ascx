...
<div style="width: <%=Width%>;">
    ...
    <div class="chart-subtitle">ÇAĞRI İSTEKLERİ DAĞILIMI</div>
    <dxchartsui:WebChartControl ID="ChartControl" runat="server" SeriesDataMember="SeriesName" ClientIDMode="AutoID" Height="220px" CrosshairEnabled="True"
        ...
        <seriestemplate argumentdatamember="PointName" crosshairlabelpattern="{V:F2}" labelsvisibility="False" valuedatamembersserializable="Value">
            <viewserializable>
