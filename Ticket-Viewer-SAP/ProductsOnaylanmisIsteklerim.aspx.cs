...
public partial class Products : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        var list = db.S_Destec_CagriOnaylananIsteklerim(-1, userId).ToList();
    ...
    private void CagriDetaylariniYukle(int _ID)
    {
        ...
        //çağrı detayları javascriptte doluyor buna gerek yok.
        

        //var list = db.S_Destec_CagriOnaylananIsteklerim(id, userId).ToList();
        //if(list.Count > 0)
        //{
        //    SirketKodu.Text = "Yok";
