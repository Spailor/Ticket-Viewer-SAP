...
public partial class HorizontalBarChart : SimpleChartControlBase {
    ...
    protected void ChartControl_CustomDrawAxisLabel(object sender, CustomDrawAxisLabelEventArgs e) {
        ...
        {
            string qwe = ScaleHelper.GetCurrencyAbbreviationMask(e.Item.Text, AbbreviationType);

            string[] paraBirimiKes = qwe.Split(' '); //para birimi sembolünü kesiyorum.

            e.Item.Text = paraBirimiKes[0].ToString();//.Substring(1, qwe.Length - 1);
        }
